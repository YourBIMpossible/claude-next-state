...
[OPS-RESIDENCY-SITE-DEPLOY] Deploy data-policy page to yourbimpossible.com -- built locally, site returns 404
...
[P7-SYNC-COMMENT-CRYPTO-BINDING] Cryptographically bind the sync approval/comment text into the one-time sync token / attestation — only if that text becomes security-relevant
       unblocks 0 · S · bimpossible+addins · CLAIMED 2026-08-23 · Today the token binds firm/user/document_title only (backend/revit_l…
...
[P15-15D-MODEL-WRITES] Build AI-assisted model writes (15d), gated on Phase 7 go-live
       unblocks 0 · L · bimpossible+addins · CLAIMED 2026-08-23 · BIMpossible_PHASE-STATUS.md, Phase 15 row 15d -- ledger states this …
...
[ADDINS-SYNC-TOKEN-HANDSHAKE] Build in-process sync-token handshake in RevitLink add-in so EventDispatcher can safely allow sync_with_central over the pipe
       unblocks 2 · M · addins+bimpossible · VERIFIED 2026-08-23 · SyncWithCentralCommand.cs header comment (2026-07-16/2026-07-27 audi…
...
[ARCH-FIRM-ALIAS-BACKEND] Firm-alias layer SHIPPED -- BIMpossible firm-literal baseline now ZERO (126 -> 21 -> 0), Add-Ins 29 -> 5
       unblocks 1 · S · bimpossible+addins · VERIFIED 2026-08-23 · BIMpossible #257 (85c3fff, MERGED 2026-08-05T23:43:21Z) -- backend/a…

[P3-8-SLICE23] Phase 3.8 slice 3 (ACC role sync) MERGED dark; slice 2 still needs one owner ruling
       unblocks 1 · S · bimpossible · VERIFIED 2026-08-18 · BIMpossible #275 MERGED 2026-08-17 (owner ruling: merge tonight, dar…
...
[SEC-PDP-G1-VIEWER-PROXY] G1 SDK-shaped per-model Viewer proxy — viewer-token containment, staging-validated (flag OFF)
       unblocks 1 · M · bimpossible · VERIFIED 2026-08-23 · BIMpossible#456 MERGED 2026-08-23 -> 534d8038 -- authoritative proxy…
...
[BIMP-RELAY-ERROR-MAP-GAP] Backend _RELAY_ERROR_MAP lacks relay codes TIMEOUT / PIPE_BUSY / METHOD_NOT_ALLOWED -- they collapse to opaque 500s instead of typed 4xx/503 responses
       unblocks 0 · S · bimpossible · VERIFIED 2026-08-25 · Observed 2026-08-25 during P7-RELAY-SESSION-LIFECYCLE discovery: bac…
...
[BIMP-P12-OPSDOCS-COMMIT] Five finished P7/P10-P12 relay ops closeout docs sit untracked in worktree bimpossible-next-f9990d (branch claude/bimpossible-next-dffbee) -- committing them trips doc-references.json (22 new unresolved: bare BIMpossible-AddIns .cs paths, relay bin/deploy artifact paths) and docs-budget.json (word ceiling, ~110.6k > 110k) simultaneously
       unblocks 0 · S · bimpossible · CLAIMED 2026-08-26 · Untracked files: docs/ops/2026-08-25-revit-dll-deployment-ownership-…
...
[AUDIT-2026-08-08-REMEDIATION] 2026-08-08 incremental audit: 25 findings resolved, CI green, report + resolution record filed
       unblocks 0 · M · bimpossible+workspace · VERIFIED 2026-08-26 · BIMpossible #324 (3116d10, merged 2026-08-08) -- H-1 slack require_i…

[AUDIT-2026-08-17-REMEDIATION] 2026-08-17 audit program CLOSED: BIMpossible remediation PRs merged, CI green, deployed
       unblocks 0 · M · bimpossible+workspace · VERIFIED 2026-08-26 · BIMpossible half of the 2026-08-17 audit remediation, all MERGED: #3…
...
[AUDIT-ESTATE56-CLOSURE-20260826] 2026-08-17 audit estate CLOSED 56->0: 2026-08-24/25/26 reconciliation across bimpossible+addins+workspace
       unblocks 0 · M · bimpossible+addins+workspace · VERIFIED 2026-08-26 · workspace 02_Reference/Audit and Scan Info/audit-closure-COMPLETE_20…
...
[P15-15C-REVIT-CONTEXT-INJECTION] Build Revit-context injection (15c), paused on hub cutover gate
       unblocks 0 · M · bimpossible+addins · VERIFIED 2026-08-23 · BIMpossible_PHASE-STATUS.md, Phase 15 row 15c -- ledger's own wordin…
...
[DOC-PHASESTATUS-191] Correct BIMpossible_PHASE-STATUS.md Phase 7 row -- calls PR #191 'open', it MERGED 2026-07-23
       unblocks 0 · S · bimpossible · VERIFIED 2026-08-27 · BIMpossible #191 'Phase 7 Gate G2: SSA cloud-open spike (hand-run)' …
...
[ADDINS-JTI-REPLAY-PERSIST] Persist (or TTL-bound) the add-in's process-local syncAuth jti replay cache so an add-in restart inside the 600s attestation TTL cannot re-enable a consumed attestation
       unblocks 0 · S · addins+bimpossible · VERIFIED 2026-08-24 · BIMpossible decision-log/2026-08-21__p7-hardening-followons-queued.m…
...
[OPS-WORKTREE-DRIFT-REVIEW] Recurring per-repo drift review: workspace local behind-6/ahead-1 with dirty ledgers + untracked audit docs
       unblocks 0 · S · workspace+bimpossible · CONTRADICTED 2026-08-26 · 2026-08-07 (original): workspace carried 2 untracked docs (revitlink…
       ⚠ both readings unresolved — TWO READINGS, not resolved: (1) 2026-08-23 overnight review found all three checkouts clean (behind-0/ahead-0, no dirty files except one untouched nor…
...
[MODEL-INDEX-RECONCILE-NAMELESS-RVT-EDGE] model_index_sync reconcile: a discovered rvt with a valid id but momentarily missing/empty name is `continue`d before discovered_ids.add(item_id) (model_index_sync.py:93), so its live row is excluded from the discovered set and the tombstone sweep (model_index_sync.py:131-133) soft-deletes a still-present model until a later crawl returns the name and restores it
       unblocks 0 · S · bimpossible · UNVERIFIED 2026-08-24 · Found 2026-08-24 in the /code-review pass on PR #466 (CONFIRMED, low…
...
[PERF-PDP-PROXY-MISS-SENTINEL-EVICTION] Negative manifest memo shares the bounded ManifestCache and can evict real manifests
       unblocks 0 · S · bimpossible · CLAIMED 2026-08-23 · Self-review of PR#463 (2026-08-23), finding 3. Read from the code, n…

[PERF-PDP-PROXY-PROJECT-MODEL-LIST] Bound and cache _list_project_models: two unbounded .all() queries per shared-texture miss
       unblocks 0 · S · bimpossible · CLAIMED 2026-08-23 · Self-review of PR#463 (2026-08-23), finding 2. Read from the code, n…

[ROUTER-SUPPORT-INDEX-KEY-MISMATCH] aec/router.py ~1004 support fast-path queries ModelIndex by item_id=file_urn while the index writer keys item_id=model_urn (lineage) -- fast-path may never hit; verify which URN /data/support receives and align
       unblocks 0 · S · bimpossible · CLAIMED 2026-08-24 · Found by Explore agent during P11 QA-history follow-ups session 2026…
...
[P7-RELAY-SESSION-LIFECYCLE] Customer-session relay lifecycle: the Revit add-in owns/activates the localhost relay in the signed-in session -- available when Revit starts, gone cleanly when Revit closes; no Windows service, Scheduled Task, NSSM, machine-wide secret store, or developer-only deploy path
       unblocks 0 · M · bimpossible+addins · VERIFIED 2026-08-25 · Reclassified from P7-RELAY-SERVICE-PERSIST by owner instruction 2026…
...
[ARCH-BIMP-PARAMSET] Activate the BIMP_ shared-parameter set END TO END -- define the set, then wire BOTH the writer (installer) and the reader to real entry points
       unblocks 0 · M · addins · VERIFIED 2026-08-23 · WRITER, dormant: BIMpossible.RevitLink/Conformance/DeliverableParame…
...
[SEC-PDP-MODEL-INDEX-PAIRING] APS-verify the project<->item pairing recorded by _upsert_model_index / _record_model_version
       unblocks 0 · M · bimpossible · CLAIMED 2026-08-23 · Reviewer observation (backend-endpoint-reviewer, PR#463 pass 1, find…
...
[OPS-DIST] Add-Ins installer SHIPPED (AddIns#64); lane PARKED by owner -- tools not ready, code-sign cert parked
       unblocks 1 · L · bimpossible+addins · VERIFIED 2026-08-23 · BIMpossible_PHASE-STATUS.md §Open-in-Revit; BIMpossible_ProductionRo…
...
[OPS-CLIENT-DATA-REMEDIATION] Client-data remediation: 39 cached models, PDF sets, DB cache -- PARKED with triggers
       unblocks 0 · L · bimpossible+workspace · VERIFIED 2026-08-26 · BIMpossible/decision-log/2026-08-05__client-data-remediation.md (ano…
