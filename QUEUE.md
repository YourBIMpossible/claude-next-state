...
Generated 2026-08-25 (synced). Ranked by critical path (transitive `unblocks` cone), tiebreak:
owner-gated+S effort, then effort, then risk, then id. Full algorithm:
`~/.claude/skills/next/reference/item-model.md`.

Scope: `all`. Watermarks: `bimpossible` = 2026-08-24 @ `b1a17b3` PR#471 · `addins` = 2026-08-23 @ `eb9d453` PR#100 · `workspace` = 2026-08-17 @ `134f129` PR#61 · `evidence-compiler` = 2026-08-24 @ `0ef747e7533c7cf714888076f3df6f06dd028b84` PR#5.
...
[OPS-WORKTREE-DRIFT-REVIEW] Recurring per-repo drift review: workspace local behind-6/ahead-1 with dirty ledgers + untracked audit docs
       unblocks 0 · S · workspace+bimpossible · VERIFIED 2026-08-23 · 2026-08-07 (original): workspace carried 2 untracked docs (revitlink…
