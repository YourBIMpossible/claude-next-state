...
[HUB-TENANCY-GOLIVE] Seed firm->hub binding, migrate to head (NOT e0f1a2b3c4d5 -- 4 revisions behind), restart backend, run both tenancy smokes
       unblocks 2 · S · bimpossible · CONTRADICTED 2026-08-07 · BIMpossible #264 (90088f0), #265 (1fe6010), #266 (84c94c2), #267 (71…
       ⚠ both readings unresolved — CONTRADICTION FOUND 2026-08-07 (night rescan), and it changes the runbook: this item's own stored instruction says 'migrate to e0f1a2b3c4d5', and that…
...
[OPS-LOCAL-SIGNIN-AUTHLOOP] Local sign-in auth-loops, so no signed-in UI can be visually verified before it ships
       unblocks 0 · S · bimpossible · CONTRADICTED 2026-08-08 · 01_BuildLog/2026-08-05__product-risk-assessment.md -- the local .env…
       ⚠ both readings unresolved — TWO COMPETING DIAGNOSES OF ONE SYMPTOM, both unresolved by probe -- surfaced, not picked. READING A (stored, 2026-08-06, level claimed): the local .en…

[WRITE-ENGINE-INC2] Merge Write Engine Increment 2 -- both halves built, CI green, awaiting owner merge decision
       unblocks 0 · S · bimpossible+addins · VERIFIED 2026-08-07 · BIMpossible #273 OPEN DRAFT, head feat/write-engine-increment2-typep…
...
[SEC-ASSIST-FIRMVIEW] Merge #278 -- scope the assistant briefing's firm-view count to the caller's firm
       unblocks 2 · S · bimpossible · VERIFIED 2026-08-07 · BIMpossible #278 MERGED 2026-08-07T04:44:03Z, squash commit 5190a4a4…
...
[OPS-TENANCY-DOC] Write the multi-tenant data-isolation strategy doc (audit's required TEST already shipped in PR#243)
       unblocks 1 · S · bimpossible · VERIFIED 2026-08-07 · BIMpossible_ProgramPlan_2026-05-25.md, Commercial Launch Prerequisit…
...
[SEC-GROUPS-DELIVERABLE-FIRM] Cross-firm NamedDeliverable IDOR in groups.py category derivation -- fixed and merged
       unblocks 0 · S · bimpossible · VERIFIED 2026-08-07 · backend/aec/groups.py:195-231 (_validate_members_and_compute_categor…
...
[SEC-VIEWS-PERSONAL-LISTING] list_views' personal-views query has the same missing-firm_id gap as the fixed list_groups bug
       unblocks 0 · S · bimpossible · VERIFIED 2026-08-07 · backend/aec/views.py:207-218 (list_views, GET /data/views) -- person…
...
[SEC-ASSIST-PERSONAL-VIEWCOUNT] Assistant briefing's personal_views count is the unfixed half of the SEC-ASSIST-FIRMVIEW function
       unblocks 0 · S · bimpossible · VERIFIED 2026-08-08 · backend/aec/assistant_context.py:172-178 (_assemble_project_context)…
...
[OPS-NEUTRALITY-CLOSEOUT-D6] Neutrality + remediation closeout MERGED (#297); D-6 compare-mode soak running, owner go/no-go due 2026-08-15
       unblocks 0 · M · bimpossible · CLAIMED 2026-08-07 · BIMpossible #297 (2332646) MERGED 2026-08-07 -- 'feat(closeout): rec…
...
[SEC-GROUPS-VIEWS-HUB-ISOLATION] groups.py + views.py routes check only the global project allowlist, never per-firm hub isolation
       unblocks 0 · M · bimpossible · VERIFIED 2026-08-07 · Source: parallel session's memory record named-deliverable-personal-…
...
[OPS-DIST] Code-sign Add-Ins + ship a real installer, including the Open-in-Revit opener
       unblocks 1 · L · bimpossible+addins · CLAIMED 2026-08-04 · BIMpossible_PHASE-STATUS.md §Open-in-Revit; BIMpossible_ProductionRo…
...
[SEC-ASSIST-TOOLS-PERSONAL-VIEWS] Assistant's _visible_saved_view_clause personal branch has no firm_id scope -- feeds tool_list_saved_views + tool_describe_saved_view
       unblocks 0 · S · bimpossible · CLAIMED 2026-08-07 · backend/aec/assistant_tools.py:295-309 _visible_saved_view_clause: f…
