...
[P7-SYNC-COMMENT-CRYPTO-BINDING] Cryptographically bind the sync approval/comment text into the one-time sync token / attestation — only if that text becomes security-relevant
       unblocks 0 · S · bimpossible+addins · CLAIMED 2026-08-21 · Today the token binds firm/user/document_title only (backend/revit_l…
...
[ADDINS-JTI-REPLAY-CROSS-PROCESS] Durable cross-process/restart replay semantics for the add-in syncAuth jti cache — only if a multi-process Revit topology becomes supported
       unblocks 0 · M · addins · CLAIMED 2026-08-21 · Distinct from ADDINS-JTI-REPLAY-PERSIST (single-process restart insi…
...
[ADDINS-SYNC-TOKEN-HANDSHAKE] Build in-process sync-token handshake in RevitLink add-in so EventDispatcher can safely allow sync_with_central over the pipe
       unblocks 2 · M · addins+bimpossible · VERIFIED 2026-08-19 · SyncWithCentralCommand.cs header comment (2026-07-16/2026-07-27 audi…
...
[P7-SYNC-GOLIVE] Supervised owner flag-flip: go-live Revit Link sync re-enable (Phase 7 step 2)
       unblocks 1 · S · bimpossible+addins · VERIFIED 2026-08-21 · BIMpossible#187 (2936c32f) + AddIns#11 (be4d6a8f), lockstep, both me…
